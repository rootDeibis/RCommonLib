package me.rootdeibis.commonlib.commands.executors;

import me.rootdeibis.commonlib.commands.MethodUtils;

import me.rootdeibis.commonlib.commands.context.CommandContext;
import me.rootdeibis.commonlib.commands.context.SubCommandContext;
...
public class CoreCommandExecutor extends BukkitCommand {
    ...
    private final String DEFAULT_PERMISSION_MESSAGE = "Insuficent permissions.";
    ...
    public boolean execute(CommandSender commandSender, String s, String[] args) {
        ...
        String permissionMessage = ChatColor.translateAlternateColorCodes('&', this.getPermissionMessage() != null ? this.getPermissionMessage() : DEFAULT_PERMISSION_MESSAGE);
